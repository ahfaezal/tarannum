...
def issue_certificate(
    ...
    *,
    ...
    snapshot = {
        ...
        "certificate_course_title": (course.certificate_course_title or course.title) if course else None,
        "competency_name": course.competency_name if course else None,
        ...
        "course_location": course.location if course else None,
